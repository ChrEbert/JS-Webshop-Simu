...
The display of the table with the ordered data is realised again with a document.getElementById(..)**.innerHTML** realised.The stringvariable therefor gets added each car-type line by line **+=** operator.
